                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <!-- <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu"> -->
                               ...
                               <li><a href="{{route('tempat.index')}}">Tempat</a></li>
                               <li><a href="{{route('barang.index')}}">Barang</a></li>
                               <li><a href="{{route('barangmasuk.index')}}">Barang Masuk</a></li>
                               <li><a href="{{route('penempatanbarang.index')}}">Penempatan Barang</a></li>
                               <li><a href="{{route('penyesuaianstok.index')}}">Penyesuaian Stok</a></li>
                        <!--     </ul>
                        </li> -->
                        @endif
                    </ul>
